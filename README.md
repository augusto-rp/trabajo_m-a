...
| Clase 3 | | | -0.8910*** (0.17) | 0.436 | -0.5533 (0.18)*** | 0.1198 |
| Confianza Institucional | | | | | 0.8160 (0.12)*** | 2.26 |
| | | | | | | |
...
![segunda diapositiva: 3 clases de percepcion economica. la mitad sostenimiento, 24.47% optimistas a futuro y %26.26 pesimistas](https://github.com/augusto-rp/trabajo_m-a/blob/main/presentaciones_ppt/diapo2.jpg)


![tercera diapositiva: % de hombres y mujeres en cada clase y como cada sector etaria se distribuye](https://github.com/augusto-rp/trabajo_m-a/blob/main/presentaciones_ppt/diapo3.jpg)


![cuarta diapositiva: conclusiones sobre significancia predictor de clase y confianza en apoyo a la democracia](https://github.com/augusto-rp/trabajo_m-a/blob/main/presentaciones_ppt/diapo4.jpg)


![quinta diapositiva: problema con usar clases es que oscure que hay componentes de percepcion economica que no son relevantes](https://github.com/augusto-rp/trabajo_m-a/blob/main/presentaciones_ppt/diapo5.jpg)
...
- No se reportaron dificultades significativas en el manejo de base de datos. Toda la información se encuentra disponible en [la página de la CEP](https://www.cepchile.cl/opinion-publica/encuesta-cep/)


## Fuentes de informacion

-Se revisó literatura (referenciada en primer segmento de este índice) sobre factores que inciden en el apoyo a la democracia entendida como una forma difusa de apyoo a la democracia.
Además se revisó literatura para la elaboración de análisis LCA/LPA
